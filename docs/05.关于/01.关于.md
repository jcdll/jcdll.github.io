...
- **WeChat or QQ**: <a :href="qqUrl">734533312</a>
- **Email**:  <a href="mailto:734533312@qq.com">734533312@qq.com</a>
- **GitHub**: <https://github.com/TeedyFoold>

<script>
  export default {
    data(){
      return {
        qqUrl: 'tencent://message/?uin=734533312&Site=&Menu=yes' 
      }
    },
    mounted(){
      const flag =  navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i);
      if(flag){
        this.qqUrl = 'mqqwpa://im/chat?chat_type=wpa&uin=734533312&version=1&src_type=web&web_src=oicqzone.com'
      }
    }
  }
</script>           